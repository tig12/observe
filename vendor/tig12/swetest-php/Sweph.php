...
class Sweph {
    ...
    **/
    public static $match_arg_domification = [
        DomificationConstants::PLACIDUS         => 'P',
        DomificationConstants::KOCH             => 'K',
        DomificationConstants::PORPHYRIUS       => 'O',
        DomificationConstants::REGIOMONTANUS    => 'R',
        DomificationConstants::CAMPANUS         => 'C',
        DomificationConstants::AEQUELIS         => 'A',
        DomificationConstants::WHOLE_SIGN       => 'W',
    ];
...
// a all factors
        SolarSystemConstants::SUN       => '0',
        SolarSystemConstants::MERCURY   => '2',
        SolarSystemConstants::VENUS     => '3',
        SolarSystemConstants::EARTH     => 'C',
        SolarSystemConstants::MOON      => '1',
        SolarSystemConstants::MARS      => '4',
        SolarSystemConstants::JUPITER   => '5',
        SolarSystemConstants::SATURN    => '6',
        SolarSystemConstants::URANUS    => '7',
        SolarSystemConstants::NEPTUNE   => '8',
        SolarSystemConstants::PLUTO     => '9',
        //
        SolarSystemConstants::MEAN_LUNAR_NODE   => 'm',
        SolarSystemConstants::TRUE_LUNAR_NODE   => 't',
        SolarSystemConstants::OBLIQUITY         => 'o',
        SolarSystemConstants::NUTATION          => 'n',
        SolarSystemConstants::MEAN_LUNAR_APOGEE => 'A', // black moon
        SolarSystemConstants::OSCULTATING_LUNAR_APOGEE => 'B', // true black moon ?
        //
        SolarSystemConstants::CHIRON    => 'D',
        SolarSystemConstants::PHOLUS    => 'E',
        SolarSystemConstants::CERES     => 'F',
        SolarSystemConstants::PALLAS    => 'G',
        SolarSystemConstants::JUNO      => 'H',
        SolarSystemConstants::VESTA     => 'I',
        SolarSystemConstants::CUPIDO    => 'J',
        SolarSystemConstants::HADES     => 'K',
        SolarSystemConstants::ZEUS      => 'L',
        SolarSystemConstants::KRONOS    => 'M',
        // N Apollon 
        // O Admetos 
        // P Vulkanus 
        // Q Poseidon 
    ...
    public static $match_output_planets = [
        ...
        'Mercury'       => SolarSystemConstants::MERCURY,
        'Venus'         => SolarSystemConstants::VENUS,
        'Moon'          => SolarSystemConstants::MOON,
        'Mars'          => SolarSystemConstants::MARS,
        'Jupiter'       => SolarSystemConstants::JUPITER,
        'Saturn'        => SolarSystemConstants::SATURN,
        'Uranus'        => SolarSystemConstants::URANUS,
        'Neptune'       => SolarSystemConstants::NEPTUNE,
        'Pluto'         => SolarSystemConstants::PLUTO,
        //
        'mean Node'     => SolarSystemConstants::MEAN_LUNAR_NODE,
        'true Node'     => SolarSystemConstants::TRUE_LUNAR_NODE,
        // '' => SolarSystemConstants::OBLIQUITY,
        //'' => SolarSystemConstants::NUTATION,
        'mean Apogee'   => SolarSystemConstants::MEAN_LUNAR_APOGEE, // black moon
        'osc. Apogee'   => SolarSystemConstants::OSCULTATING_LUNAR_APOGEE, // true black moon ?
        //
        'Ceres'         => SolarSystemConstants::CERES,
        'Pallas'        => SolarSystemConstants::PALLAS,
        'Juno'          => SolarSystemConstants::JUNO,
        'Vesta'         => SolarSystemConstants::VESTA,
        //
        'Chiron'        => SolarSystemConstants::CHIRON,
        'Pholus'        => SolarSystemConstants::PHOLUS,
        // '' => SolarSystemConstants::CUPIDO,
        // '' => SolarSystemConstants::HADES,
        // '' => SolarSystemConstants::ZEUS,
        // '' => SolarSystemConstants::KRONOS,
        //
    ];
    ...
    public static $match_output_houses = [
        'house  1' => DomificationConstants::H1,
        'house  2' => DomificationConstants::H2,
        'house  3' => DomificationConstants::H3,
        'house  4' => DomificationConstants::H4,
        'house  5' => DomificationConstants::H5,
        'house  6' => DomificationConstants::H6,
        'house  7' => DomificationConstants::H7,
        'house  8' => DomificationConstants::H8,
        'house  9' => DomificationConstants::H9,
        'house 10' => DomificationConstants::H10,
        'house 11' => DomificationConstants::H11,
        'house 12' => DomificationConstants::H12,
    ];
    ...
    /**
        ...
        @param  $P associative array containing :
            - 'day'                 string - WARNING sweph format d.m.y
                                    required
            ...
            - 'compute-houses'      boolean
                                    optional
                                    default false
            - 'domification-system' use a constant of DomificationConst
    ...
    **/
    public static function ephem($P){
        ...
        $args = '';
        // date time
        $args .= ' -b' . $P['day'] . ' -ut' . $P['time']; // ex -b15.12.2016 -ut14:19:55
        // planets
...
//foreach($P['planets'] as $planet){ echo "\n<br/>$planet " . $res['rise'][$planet] . ' - ' . $res['set'][$planet]; } echo "\n";// exit;
        return $res;
    }
