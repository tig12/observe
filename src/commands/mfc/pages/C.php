    ...
    public static function computePage(&$params): string {
        ...
        if($params['child-by-year'] === true){
            ...
            [$html_markup, $file_contents] = bar::svg(
                ...
                img_alt:        "$titleUCString - year of birth",
                barW:           8,
        ...
        [$html_markup, $file_contents] = bar::svg(
            ...
            img_alt:        "$titleUCString - day of birth",
            barW:           2,
            xlegends:       ['min', 'max'],
            ylegends:       ['min', 'max', 'mean'],
            ylegendsRound:  1,
        ...
        if($params['experience']['has-wedding'] === true){
            ...
            [$html_markup, $file_contents] = bar::svg(
                ...
                img_alt:        "$titleUCString - Duration between parents' wedding and birth (in months)",
                barW:           2,
                xlegends:       ['min', 'max'],
                ylegends:       ['min', 'max', 'mean'],
                ylegendsRound:  1,
        ...
        foreach($params['planets'] as $planet){
            ...
            [$html_markup, $file_contents] = bar::svg(
                ...
                img_alt:        "Child - $planetName at birth",
                barW:           2,
                xlegends:       ['min', 'max'],
                ylegends:       ['min', 'max', 'mean'],
                ylegendsRound:  1,
        ...
        for($i=0; $i < count($params['planets']); $i++){
            for($j=$i+1; $j < count($params['planets']); $j++){
                ...
                [$html_markup, $file_contents] = bar::svg(
                    ...
                    img_alt:        "Child - Aspects $planetName1 / $planetName2 at birth",
                    barW:           2,
                    xlegends:       ['min', 'max'],
                    ylegends:       ['min', 'max', 'mean'],
                    ylegendsRound:  1,
