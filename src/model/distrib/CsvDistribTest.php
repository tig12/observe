...
WANTED;
    ...
    public function test_distrib2csv_2dim_regular(){
        $a = [
            0 => [1, 2, 3, 4],
            1 => [11, 12, 13, 14],
            2 => [21, 22, 23, 24],
        ...
        $this->assertEquals(self::WANTED1, CsvDistrib::distrib2csv_2dim($a));
    }
    
    public function test_distrib2csv_2dim_associative(){
