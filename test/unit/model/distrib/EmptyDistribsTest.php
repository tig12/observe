...
class EmptyDistribsTest extends TestCase{
    ...
    public function testEmptySingleDistrib_dim1(){
        $codes = ['a', 'b', 'c'];
        $N = 3;
        $this->assertEquals(EmptyDistribs::emptySingleDistrib_dim1($codes, $N), [
                'a' => [0, 0, 0],
                'b' => [0, 0, 0],
                'c' => [0, 0, 0],
            ]
    ...
    public function testEmptyDoubleDistrib_triangle_dim1(){
        $codes1 = ['a', 'b', 'c'];
        $codes2 = ['x', 'y', 'z'];
        $N = 3;
